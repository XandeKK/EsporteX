...
$StateObj = json_decode($city);

$nameStateObj = $StateObj->estados;

foreach ( $nameStateObj as $state ){
	$nameState = $state->nome;
	
	$cityObj = $state->cidades;

	$getData = "SELECT id FROM `state_brazil` WHERE name = '$nameState'";
	...
	foreach ( $cityObj as $city){
		...
		$sql = "INSERT INTO `city_state_brazil`
		VALUES (null, '$city', '$id')";
