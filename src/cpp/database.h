...
public:
    ...
    bool putAddress(QString &state_id,
                    QString &city_id,
                    QString &user_id);
    ...
    Q_INVOKABLE QByteArray putGame(QString &game_id,
                                   QString &sport_id,
                                   QString &state_id,
                                   QString &city_id,
                                   QString &address,
